...
Base Image: Start your Dockerfile from a Jupyter Docker Stack image. For instance, use `#!docker FROM jupyter/scipy-notebook:latest`. You can explore other options on the Jupyter Docker Stacks documentation.

...
## Training with PPO and Advanced Frontiers
...
Writing RL algorithms from scratch is highly prone to bugs. Instead, the industry relies on robust, optimized libraries. We will use **Stable-Baselines3 (SB3)**, which is built on PyTorch and integrates perfectly with Gymnasium.
...
!!! note "The Sparse Reward Problem"
